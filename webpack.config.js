...
const configGenerator = (options, dir, fileNames = [], spriteGroups = []) => {
	return {
		name: dir,
		entry: [`./src/${dir}.js`],
...
//     exclude: [
//       path.resolve(__dirname, 'src/' + pathRoot + '/icons')
//     ],
//     use: [
//       {
//         loader: "url-loader",
...
const fileLoader = (pathRoot) => {
	return {
		...
		// ],
		// exclude: [
		// 	path.resolve(__dirname, 'assets/inline'),
...
module.exports = (env, options) => [ 
	configGenerator(options, 'promotion', ['list-candidate', 'register','detail', 'rank'], ['common', 'floating']), 
	configGenerator(options, 'article', ['article'], ['article']), 
];
